...
{
    // The following is MurmurHash3 (x86_64), see http://code.google.com/p/smhasher/source/browse/trunk/MurmurHash3.cpp
    ...
    //----------
    // tail
    const uint16_t * tail = (const uint16_t*)(&vDataToHash[0] + nblocks*4);
